...
---Saves the state in the global _G.Ninetyfive.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.Ninetyfive.state")

    _G.Ninetyfive.state = self
end
...
---Whether the Ninetyfive is enabled or not.
---
